...
public class SortedSet implements NavigableSet<Entry<Double, String>> {
	...
	@Override
	public NavigableSet<Entry<Double, String>> subSet(Entry<Double, String> fromElement, boolean fromInclusive, Entry<Double, String> toElement, boolean toInclusive) {
		return scores.subSet(fromElement, fromInclusive, toElement, toInclusive);
	}

	@Override
	public NavigableSet<Entry<Double, String>> headSet(Entry<Double, String> toElement, boolean inclusive) {
		return scores.headSet(toElement, inclusive);
	}

	@Override
	public NavigableSet<Entry<Double, String>> tailSet(Entry<Double, String> fromElement, boolean inclusive) {
		return scores.tailSet(fromElement, inclusive);
	}

	@Override
	public java.util.SortedSet<Entry<Double, String>> subSet(Entry<Double, String> fromElement, Entry<Double, String> toElement) {
