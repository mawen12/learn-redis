...
public class SortedSet implements NavigableSet<Entry<Double, SafeString>> {
	...
	@Override
	public NavigableSet<Entry<Double, SafeString>> subSet(Entry<Double, SafeString> fromElement, boolean fromInclusive, Entry<Double, SafeString> toElement, boolean toInclusive) {
		return scores.subSet(fromElement, fromInclusive, toElement, toInclusive);
	}

	@Override
	public NavigableSet<Entry<Double, SafeString>> headSet(Entry<Double, SafeString> toElement, boolean inclusive) {
		return scores.headSet(toElement, inclusive);
	}

	@Override
	public NavigableSet<Entry<Double, SafeString>> tailSet(Entry<Double, SafeString> fromElement, boolean inclusive) {
		return scores.tailSet(fromElement, inclusive);
	}

	@Override
	public java.util.SortedSet<Entry<Double, SafeString>> subSet(Entry<Double, SafeString> fromElement, Entry<Double, SafeString> toElement) {
